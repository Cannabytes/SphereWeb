...
return [
    'ru' => [
		...
		'community_1' 		      => 'СООБЩЕСТВО #1',
		'community_2' 	    	  => 'СООБЩЕСТВО #2',
		'community_3' 	    	  => 'СООБЩЕСТВО #3',
		'community_4' 	    	  => 'СООБЩЕСТВО #4',

        'lk'                     => 'Личный кабинет',
        'start_game'             => 'Начать играть',
        'stream_info'            => 'Для размещения <span>STREAM</span> трансляции обратитесь по нашим контактам',
        'top_players'            => 'РЕЙТИНГ ИГРОКОВ',
        'top_clans'            => 'РЕЙТИНГ ИГРОКОВ',
