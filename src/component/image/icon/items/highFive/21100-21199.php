...
return [
  ...
  [
    ...
    'name' => 'Wedding Veil',
    'add_name' => '',
    'description' => 'Pure white and shiny wedding veil. Female exclusive  Uses 2 hair accessory slot(s]. Cannot be exchanged, dropped, or sold. Can be stored in a private warehouse.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'A wedding bouquet of beautiful flowers. Female exclusive  Cannot be exchanged, dropped, or sold. Can be stored in a private warehouse.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Dimensional  Magic scroll that moves you to the nearest village. Cannot be exchanged or dropped. Can be shared between characters within an account through the Dimensional Merchant. Can be stored in a private warehouse.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Dimensional  Magic potion that temporarily and greatly recovers stamina. Cannot be exchanged or dropped. Can be shared between characters within an account through the Dimensional Merchant. Can be stored in a private warehouse.',
