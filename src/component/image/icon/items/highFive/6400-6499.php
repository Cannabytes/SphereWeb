...
return [
  ...
  [
    ...
    'name' => 'Star Shard',
    'add_name' => '',
    'description' => 'u,Starlight Festival Event – A gift from the sky. When it is thrown, it creates a small explosion. Can be used as an ingredient to make other types of fireworks.',
  ...
  [
    ...
    'name' => 'Gunpowder',
    'add_name' => '',
    'description' => 'Starlight Festival Event - Black powder. An ingredient used to make larger fireworks.',
  ...
  [
    ...
    'name' => 'Magnesium',
    'add_name' => '',
    'description' => 'Starlight Festival Event - A chemical compound that generates a powerful flash when ignited. It is needed to make large fireworks.',
  ...
  [
    ...
    'name' => 'Firework',
    'add_name' => '',
    'description' => 'An explosive device that brilliantly lights up the sky.',
  ...
  [
    ...
    'name' => 'Large Firework',
    'add_name' => '',
    'description' => 'A large explosive device that ignites to light up the sky.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Double-click to randomly change into another item. The changed item can be used as an ingredient for general manufacture.',
    'icon' => 'etc_tuna_i07',
    'weight' => 100,
    'price' => 138,
    'is_stackable' => true,
