...
return [
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch fast-moving low grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 5,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch fast-moving fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It lure cannot be used during the day.',
    'icon' => 'etc_bait_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 4,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch fast-moving high grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 3,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch broad low grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 5,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch broad fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_bait_i01',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 4,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch broad high grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 3,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch ugly low grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 5,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch ugly fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_bait_i02',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 4,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This fishing lure can be used to catch ugly high grade fish at night. The higher the lure\'s grade, the faster the fish will take the bait. It cannot be used during the day.',
    'icon' => 'etc_gludio_fish_lure_i00',
    'etcitem_type' => 'lure',
    'bodypart' => 'lhand',
    'weight' => 3,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war. (For Level 1 - Level 19]',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war. (For Level 20 - Level 39] ',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war. (For Level 40 - Level 51] ',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war. (For Level 52 - Level 60] ',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war. (For Level 61 ~ Level 75]  ',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Prevents Exp. loss if killed during a siege war (for Level 76 - Level 80]. Can also be used by characters below level 76.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a C-Grade, low quality accessory.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a C-Grade, medium quality accessory.',
    'icon' => 'etc_box_of_adventure_1_i00',
    'weight' => 20,
    'is_stackable' => true,
    'handler' => 'itemskills',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a C-Grade, high quality accessory.',
    'icon' => 'etc_box_of_adventure_1_i00',
    'weight' => 20,
    'is_stackable' => true,
    'handler' => 'itemskills',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a B-Grade, low quality accessory.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a B-Grade, high quality accessory.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a Raider\'s Hair Accessory.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Open the box for a chance to obtain a Cradle of Creation.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This token is used to help novice travelers move to various places. Characters under level 20 may redeem it at a Newbie Guide for travel between Talking Island Village, Dark Elf Village, Elven Village, Dwarven Village and Orc Village.',
  ...
  [
    ...
    'name' => 'Old Box',
    'add_name' => '',
    'description' => 'An old box that can be caught by fishing in the Hot Springs area. If you double-click it, you can obtain the Certificate for Participation in a Clan Hall war in the Hot Springs at a certain rate of probability.',
    'icon' => 'etc_box_of_adventure_1_i00',
    'weight' => 100,
    'price' => 1500,
    'is_stackable' => true,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'Clicking the Dewdrop of Destruction will make the portrait disappear. It will disappear when one enters the Last Imperial Sepulcher.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'This hair accessory is awarded to the winners of the Fishing King Championship Tournament.',
  ...
  [
    ...
    'name' => 'Iron Circlet',
    'add_name' => '',
    'description' => 'Hair accessory used in overseas events.  This item is designed for use in events only and cannot be exchanged or dropped.',
  ...
  [
    ...
    'name' => 'Event Gift Box',
    'add_name' => '',
    'description' => 'An item that is used for the PC Café coupon event.  If you double-click it, it will randomly change to a different  This item cannot be exchanged or dropped. (This item can be used when the weight gauge shows less than 80% and 10 or more empty slots are available in the inventory.]',
    'icon' => 'etc_box_of_adventure_3_i00',
    'weight' => 20,
    'is_tradable' => false,
    'is_dropable' => false,
  ...
  [
    ...
    'add_name' => '',
    'description' => 'An item that is used for the PC Café coupon event. An exchange coupon that can be used to exchange for a no grade weapon at Adventurers\' Guild.',
  ...
  [
    ...
    'add_name' => '',
    'description' => 'An item that is used for the PC Café coupon event.  An exchange coupon that can be used to exchange for a D grade weapon at Adventurers\' Guild.',
    'icon' => 'etc_lottery_card_i00',
    'etcitem_type' => 'coupon',
    'weight' => 1,
    'is_tradable' => false,
