...
return [
  ...
  [
    ...
    'name' => 'Event Gift Box',
    'add_name' => '',
    'description' => 'An item that is used for the PC Café coupon event.  If you double-click it, it will randomly change to a different item. This item cannot be exchanged or dropped. (This item can be used when the weight gauge shows less than 80% and 10 or more empty slots are available in the inventory.]',
    'icon' => 'etc_box_of_adventure_3_i00',
    'weight' => 20,
    'is_tradable' => false,
    'is_dropable' => false,
