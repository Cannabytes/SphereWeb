...
return [
    ...
    268 => "HTML page that we will send to the user by email.<br>
            ...
            Template Location: <strong>template/cabinet/email_request/forget.html</strong>",
    269 => "HTML page that we will send to the user by email.<br>
            ...
            Template Location: <strong>template/cabinet/email_request/new_password.html</strong>",
    270 => "Mail settings",
    271 => "Save",
