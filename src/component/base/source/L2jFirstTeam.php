...
class L2jFirstTeam implements structure {
    ...
    static public function statistic_top_pvp(): string {
        return 'SELECT
                ...
                ORDER BY pvpkills DESC LIMIT 100;';
    }
    ...
    static public function statistic_top_pk(): string {
        return 'SELECT
                ...
                FROM
                    ...
                    LEFT JOIN clan_data ON characters.clanid = clan_data.clan_id
                    LEFT JOIN ally_data ON clan_data.ally_id = ally_data.ally_id
                ORDER BY pkkills DESC LIMIT 100;';
    }
    ...
    static public function statistic_top_heroes(): string {
        return 'SELECT
                ...
                FROM
                    ...
                    LEFT JOIN clan_data ON characters.clanid = clan_data.clan_id
                    LEFT JOIN ally_data ON clan_data.ally_id = ally_data.ally_id
                    INNER JOIN character_subclasses ON heroes.char_id = character_subclasses.char_obj_id
