...
class L2jEternity implements structure {
    ...
    static public function statistic_clan_data(): string {
        return 'SELECT
                ...
                FROM
                    ...
                    LEFT JOIN fort ON clan_data.clan_id = fort.`owner`
                WHERE
...
FROM
	heroes
	LEFT JOIN characters ON heroes.charId = characters.charId
	LEFT JOIN clan_data ON characters.clanid = clan_data.clan_id 
ORDER BY
    ...
    static public function statistic_player_info(): string {
        return 'SELECT
                    ...
                    characters.pvpkills AS pvp,
                    characters.pkkills AS pk,
                    UNIX_TIMESTAMP(characters.createDate) AS createtime,
                    characters.title,
                    characters.`online`,
                    characters.onlinetime AS time_in_game,
                    characters.base_class as class_id,
